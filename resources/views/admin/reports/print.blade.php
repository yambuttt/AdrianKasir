...
<table>
  <thead>
    <tr>
      <th>Waktu</th><th>Kode</th><th>Kasir</th>
  ...
  <tfoot>
    <tr><td colspan="8" class="right"><b>Omzet Kotor</b></td><td class="right"><b>{{ number_format($gross,0,',','.') }}</b></td></tr>
    <tr><td colspan="8" class="right"><b>Refund Uang</b></td><td class="right"><b>- {{ number_format($refund,0,',','.') }}</b></td></tr>
    <tr><td colspan="8" class="right"><b>Omzet Nett</b></td><td class="right"><b>{{ number_format($nett,0,',','.') }}</b></td></tr>
  </tfoot>
</table>
</body>
</html>
