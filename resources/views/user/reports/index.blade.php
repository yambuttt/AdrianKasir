...
<div class="space-y-6">
  <div class="flex items-center justify-between">
    ...
    <div class="flex gap-2">
      <a href="{{ route('user.reports.export.csv', request()->query()) }}" class="px-3 py-1.5 border rounded">Export Excel (CSV)</a>
      <a href="{{ route('user.reports.export.print', request()->query()) }}" target="_blank" class="px-3 py-1.5 border rounded">Export PDF (Cetak)</a>
    </div>
  </div>
  ...
  <form method="GET" class="flex flex-wrap items-end gap-3">
    ...
    <a href="{{ route('user.reports.index') }}" class="px-4 py-2 border rounded">Reset</a>
  </form>
